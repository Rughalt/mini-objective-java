...
public class DataRepositoryTest {
     ...
     */
    @org.junit.Test(timeout = 1800)
    public void getAllProductsAndProductsByIdOptimization() {
        CachingAndPagingDataRepository dataRepository = new CachingAndPagingDataRepository();
        int randomProductId = (int)Math.floor(Math.random() * 6) + 2;
        // Inital get data
        Collection<SimpleDataRepository.Product> data = dataRepository.getAllProducts();
     ...
     */
    @org.junit.Test(timeout = 2800)
    public void getAllProductsAndWarehouses() {
        CachingAndPagingDataRepository dataRepository = new CachingAndPagingDataRepository();
        // Inital get data
     ...
     */
    @org.junit.Test(timeout = 1800)
    public void getAllProductsSortedName() {
        CachingAndPagingDataRepository dataRepository = new CachingAndPagingDataRepository();
     ...
     */
    @org.junit.Test(timeout = 1800)
    public void getAllProductsFilteredByExpiresTrueAndSortedName() {
        CachingAndPagingDataRepository dataRepository = new CachingAndPagingDataRepository();
    ...
    public void updateProductInRepository() {
        CachingAndPagingDataRepository dataRepository = new CachingAndPagingDataRepository();
        int randomProductId = (int)Math.floor(Math.random() * 6) + 2;
        // Inital get data
        SimpleDataRepository.Product product1 = dataRepository.getProductsById(1);
    ...
    public void upsertInsertProductInRepository() {
        CachingAndPagingDataRepository dataRepository = new CachingAndPagingDataRepository();
        int randomProductId = (int)Math.floor(Math.random() * 6) + 2;
        // Inital get data
        SimpleDataRepository.Product product1 = dataRepository.getProductsById(1);
        ...
        // Get data, again...
        product1 = dataRepository.getProductsById(1);
        SimpleDataRepository.Product product10 = dataRepository.getProductsById(10);
        productData = dataRepository.getAllProducts();
        warehouseData = dataRepository.getAllWarehouses();
    ...
    public void upsertUpdateProductInRepository() {
        CachingAndPagingDataRepository dataRepository = new CachingAndPagingDataRepository();
        int randomProductId = (int)Math.floor(Math.random() * 6) + 2;
        // Inital get data
        SimpleDataRepository.Product product1 = dataRepository.getProductsById(1);
