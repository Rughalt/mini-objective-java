...
public class SimpleDataRepository {
    ...
    /**
     * Repository initializaion
     */
    public SimpleDataRepository() {
        products = new HashMap<>(Map.of(
                1, new Product(1, "Eggs",0.29,true),
                2, new Product(2, "Sugar",1.99,true),
                3, new Product(3, "Milk",1.09,true),
                4, new Product(4, "Honey",2.99,false),
                5, new Product(5,"Mascarpone",1.99,true),
                6, new Product(6,"Tomato",3.99,true),
                7, new Product(7, "Printer Paper",2.99,false),
                8, new Product(8, "Printer Toner",12.99,false),
                9, new Product(9, "Thermal Paste",1.99,true)
        ));

        warehouses = new HashMap<>(Map.of(
                1, new Warehouse(1,  "TX", false, List.of(7,8,9)),
                2, new Warehouse(2,  "AU", true, List.of(1,2,3,4,5,6)),
                3, new Warehouse(3,  "CA", true, List.of())
        ));
    }
    ...
    public static class Product {
        ...
        private Product(int id, String name, double price, boolean expires) {
            this.id = id;
            this.name = name;
            this.price = price;
